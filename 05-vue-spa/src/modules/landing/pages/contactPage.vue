<template>
  <section class="text-gray-600 body-font relative w-full min-h-[500px]">
    ...
    <div class="container px-5 py-24 mx-auto flex relative z-10">
      <div
        class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 shadow-md"
      >
